...
var contactFormDB = firebase.database().ref("orderInfo");

document.getElementById("orderInfo").addEventListener("submit", submitForm);
...
function submitForm(e) {
  ...
  var carid = getElementVal("carid");
  var location = getElementVal("location");
  var phone = getElementVal("phone");
  var date = getElementVal("date");

  saveMessages(name, emailid, carid, location, phone, date);
...
const saveMessages = (name, emailid, carid, location, phone, date) => {
